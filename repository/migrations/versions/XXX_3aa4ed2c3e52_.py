...
Revision ID: 3aa4ed2c3e52
Revises: None
Create Date: 2015-06-12 13:56:41.329977
"""
...
def upgrade():
    ...
    sa.Column('status', sa.INTEGER(), server_default='0', autoincrement=False, nullable=True),
    sa.Column('message', sa.TEXT(), nullable=True),
    sa.Column('collector_error', sa.TEXT(), nullable=True),
    sa.Column('last_timestamp', sa.DATETIME(), nullable=True),
    sa.Column('poll_interval', sa.INTEGER(), server_default='60', autoincrement=False, nullable=True),
    ...
    sa.Column('server', sa.VARCHAR(length=100), server_default='', nullable=False),
    sa.Column('timestamp', sa.DATETIME(), server_default='0000-00-00 00:00:00', nullable=False),
    sa.Column('status', sa.VARCHAR(length=32), server_default='', nullable=False),
    ...
    sa.Column('rowid', sa.INTEGER(), server_default='0', autoincrement=False, nullable=False),
    ...
    sa.Column('display_value', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['uid'], [u'metric.uid'], name='metric_data_to_metric_fk', onupdate='CASCADE', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('uid', 'rowid')
    )
    op.create_index('anomaly_score_idx', 'metric_data', ['anomaly_score'], unique=False)
